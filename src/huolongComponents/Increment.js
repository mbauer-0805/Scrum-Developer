        ...
        return (
                <div className="contentleft">
                    ...
                    <p>The Increment is the sum of all the Product Backlog items completed during a Sprint and
                        ...
                        must be &ldquo;Done,&rdquo; which means it must be in useable condition and meet the
                        Scrum
                        Team&rsquo;s definition>of &ldquo;Done.&rdquo; An increment is a body of inspectable,
                        done
                        work that supports empiricism at the end of the Sprint. The increment is a step toward a
                        vision or goal. The increment must be in useable condition regardless of whether the
                        Product
