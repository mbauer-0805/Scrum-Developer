    ...
    render() {
        return (
            ...
            <div className="CustomComponent-div">
                ...
                <img src={contIntegration} width="800px" className="CustomComponent-Img" alt="logo" />
                <p />
                <img src={contIntegrationBrands} width="800px" className="CustomComponent-Img" alt="logo" />
                ...
                <div className="contentleft">
                    ...
                    <ul>
                        ...
                        <li>The team members: discuss the detail, ask questions, choose items for sprint backlog</li>
                    </ul>
                    <p>When&nbsp;</p>
                    <ul>
